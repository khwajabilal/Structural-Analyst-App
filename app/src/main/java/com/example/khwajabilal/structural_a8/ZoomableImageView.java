...
/**
 * Created by KhwajaBilal on 5/2/2016.
 */
...
public class ZoomableImageView extends View  {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(isSelection)
        {
            Toast.makeText(getContext(),"in zoom if",Toast.LENGTH_SHORT).show();
            selectclass.setX_CoordinateClicked(event.getX());
            Log.d("x clicked", String.valueOf(event.getX()));
            selectclass.setY_CoordinateClicked(event.getY());
            Log.d("y clicked", String.valueOf(event.getY()));
            selectclass.getNearestItemSelected();
        }
        else {
    ...
    public void setSelectclass(SelcetionClass selectclass) {
        this.selectclass = selectclass;
    }


//    public Bitmap setGraph(Bitmap bitmap)
//    {
//
//    }
}